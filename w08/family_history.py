...
def print_death_age(people_dict):
    ...
    for name in people_dict:
        ...
        first_last_name = value[NAME_INDEX]
        death_year = value[DEATH_YEAR_INDEX]

        print(f"{first_last_name} {death_year}")
...
def count_genders(people_dict):
    ...
    print(f"Number of Females: {male_total}")
...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriage in marriages_dict:
        ...
        male_key = people_dict[husband_name]
        female_key = people_dict[wife_name]

        husband_age = wedding_year - male_key[2]
        wife_age = wedding_year - female_key[2]


        print(f'{male_key[0]} {husband_age} > {wedding_year} < {wife_age} {female_key[0]}')   
