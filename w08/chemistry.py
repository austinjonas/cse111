def main():
    ...
    chemical_formula = input("Please input a molecular formula: ")
    grams_mass = float(input("Enter the mass of the sample: "))
    symbol_quantities = parse_formula(chemical_formula, periodic_table)

    total_mass = compute_molar_mass(symbol_quantities, periodic_table)

    print(f'{total_mass: .5f} grams/mole')
    new_mass = grams_mass / total_mass 
    print(f"{new_mass: .5f} moles")
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for element_list in symbol_quantity_list:
        ...
        element_attributes = periodic_table_dict[atom]
        atomic_mass = quantity * element_attributes[1]
